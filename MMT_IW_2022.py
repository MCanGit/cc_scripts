...
MMT_Path = r"Z:\Operations - Management\Lisbon Reporting\11. Extras\11. Mário\.01\20. Unpivot 2022\MMT 2022.csv"
...
mmt = pd.read_csv(MMT_Path, usecols=['enterprise_id',
                                                'role',
                                                'employee_status',
                                                'skills',
                                                'cluster',
...
mmt.to_parquet(r"Z:\Operations - Management\Lisbon Reporting\11. Extras\11. Mário\.01\20. Unpivot 2022\MMT_2022.parquet")
#print(mmt.info())
